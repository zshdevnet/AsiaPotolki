        ...
        <header>
          <Stack spacing={3} textAlign="center">
            ...
            <Text
              ...
              mx="auto"
            >
              Professional stretch ceiling installation, lighting integration,
              and repair services. Fast, clean, guaranteed work with 15+ years
              of experience.
            </Text>
          </Stack>
        </header>
      ...
      <Container py={{ base: 10, md: 16 }}>
        ...
        >
          ...
          <Text color="slate.500" fontSize={{ base: "md", md: "lg" }}>
            Get a free consultation and estimate for your project. No
