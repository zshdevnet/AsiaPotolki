...
const materials: MaterialType[] = [
    {
        ...
        nameRu: "Матовые",
        icon: Layers,
        description: "Classic matte finish that creates a smooth, elegant surface without glare. Perfect for any room where you want sophisticated, understated luxury.",
        features: ["No glare or reflections", "Hides imperfections well", "Classic elegant look", "Easy to clean"],
    ...
    },
    {
        ...
        nameRu: "Глянцевые", 
        icon: Circle,
        description: "High-gloss mirror-like surface that reflects light beautifully, making spaces appear larger and brighter. Creates stunning visual impact.",
        features: ["Mirror-like reflection", "Brightens spaces", "Modern aesthetic", "Easy to wipe clean"],
    ...
    },
    {
        ...
        nameRu: "Сатиновые",
        icon: Sparkles,
        description: "Perfect balance between matte and glossy - subtle sheen with soft light reflection. Combines elegance with practicality for versatile applications.",
        features: ["Subtle pearl-like sheen", "Balanced light reflection", "Versatile for any decor", "Fingerprint resistant"],
    ...
    },
    {
        ...
        nameRu: "Тканевые",
        icon: Shirt,
        description: "Premium textile stretch ceilings offering natural texture and breathability. Eco-friendly option with acoustic properties and unique aesthetic appeal.",
        features: ["Natural textile texture", "Breathable material", "Acoustic properties", "Eco-friendly option"],
...
export default function MaterialsCatalogPage({ onBackToHome }: MaterialsCatalogPageProps) {
            ...
            <Container as={Stack} spacing={{ base: 6, md: 10 }} py={{ base: 6, md: 12 }}>
                <header>
                    <Stack spacing={3} textAlign="center">
                        ...
                        <Text as="p" color="slate.500" fontSize={{ base: "md", md: "lg" }} maxW="3xl" mx="auto">
                            Discover our collection of premium stretch ceiling materials. Each finish offers unique characteristics 
                            to perfectly complement your interior design vision and functional requirements.
                        </Text>
                    </Stack>
                </header>
            </Container>
                        ...
                        >
                            ...
                            <Box position="relative" h="200px">
                                ...
                                <Box
                                    ...
                                    rounded="full"
                                >
                                    <Icon as={material.icon} boxSize={5} color="brand.500" />
                                </Box>
                                <Badge
                                    position="absolute"
                                    bottom={3}
                                ...
                                <VStack align="start" spacing={4}>
                                    ...
                                    <VStack align="start" spacing={1} w="full">
                                        ...
                                        {material.features.slice(0, 2).map((feature, index) => (
                                            <HStack key={index} spacing={2}>
                                                <Box w={1} h={1} bg="brand.500" rounded="full" flexShrink={0} />
                                    ...
                                    <Box w="full">
                                        <HStack justify="space-between" mb={1}>
                                            <Text fontSize="xs" color="gray.500">Durability</Text>
                                            <Text fontSize="xs" color="gray.500">{material.durability}%</Text>
                                        </HStack>
                                        <Box h={2} bg="gray.200" _dark={{ bg: "gray.600" }} rounded="full">
                                            <Box 
                                                h="full" 
                                                bg="brand.500" 
                                                rounded="full" 
                ...
                >
                    <Stack spacing={4} align="center">
                        ...
                        <Text maxW="2xl" color="gray.600" _dark={{ color: "gray.300" }}>
                            Our expert team can help you select the perfect material for your project. 
