...
import { ArrowLeft, Check, Star, Shield, Droplets, Flame, Calendar, Ruler, Eye, Palette } from "lucide-react";
...
export default function MaterialDetailPage({ material, onBack }: MaterialDetailPageProps) {
                ...
                <Stack spacing={6}>
                    ...
                    <SimpleGrid columns={{ base: 1, lg: 2 }} gap={8} alignItems="center">
                        <Box>
                            ...
                            <Text fontSize="xl" color="gray.600" _dark={{ color: "gray.300" }} mb={6}>
                                {material.description}
                            </Text>
                            <HStack spacing={6} mb={6}>
                                <Box>
                                    <Text fontSize="sm" color="gray.500" mb={1}>Price Range</Text>
                                ...
                                <Box>
                                    <Text fontSize="sm" color="gray.500" mb={1}>Durability</Text>
                                    <HStack>
                                        <Progress 
                                    ...
                                    <CardBody p={6}>
                                        ...
                                        <VStack align="stretch" spacing={4}>
                                            <Flex justify="space-between" align="center">
                                                ...
                                                <Text fontWeight="600">{material.specifications.thickness}</Text>
                                            </Flex>
                                            <Divider />
                                            <Flex justify="space-between" align="center">
                                                <HStack>
                                                ...
                                                <Text fontWeight="600">{material.specifications.width}</Text>
                                            </Flex>
                                            <Divider />
                                            <Flex justify="space-between" align="center">
                                                <HStack>
                                                ...
                                                <Text fontWeight="600">{material.specifications.texture}</Text>
                                            </Flex>
                                            <Divider />
                                            <Flex justify="space-between" align="center">
                                                <HStack>
                                                ...
                                                <Text fontWeight="600">{material.specifications.lightReflection}</Text>
                                            </Flex>
                                            <Divider />
                                            <Flex justify="space-between" align="center">
                                                <HStack>
                                                ...
                                                <Text fontWeight="600">{material.specifications.warranty}</Text>
                                            </Flex>
                                        </VStack>
                                    </CardBody>
                                </Card>
                                        ...
                                        <VStack align="stretch" spacing={4}>
                                            <HStack justify="space-between">
                                                <HStack>
                                                    <Icon 
                                                        as={Droplets} 
                                                        color={material.specifications.waterResistant ? "green.500" : "red.500"} 
                                                    />
                                                    <Text>Water Resistant</Text>
                                                </HStack>
                                                <Badge 
                                                    colorScheme={material.specifications.waterResistant ? "green" : "red"}
                                                >
                                                    {material.specifications.waterResistant ? "Yes" : "No"}
                                                </Badge>
                                            </HStack>
                                            <Divider />
                                            <HStack justify="space-between">
                                                <HStack>
                                                    <Icon 
                                                        as={Flame} 
                                                        color={material.specifications.fireRetardant ? "green.500" : "red.500"} 
                                                    />
                                                    <Text>Fire Retardant</Text>
                                                </HStack>
                                                <Badge 
                                                    colorScheme={material.specifications.fireRetardant ? "green" : "red"}
                                                >
                                            ...
                                            <Divider />
                                            <Box>
                                                <Text fontSize="sm" color="gray.500" mb={2}>Maintenance Level</Text>
                                                <Text fontWeight="600">{material.maintenance}</Text>
                                            </Box>
                                            <Divider />
                                            <Box>
                                                <Text fontSize="sm" color="gray.500" mb={2}>Best For</Text>
                                    ...
                                    <List spacing={4}>
                                        {material.advantages.map((advantage, index) => (
                                            <ListItem key={index}>
                                                ...
                                                <Text as="span" fontSize="lg">{advantage}</Text>
                                            </ListItem>
                                        ))}
                                    </List>
                                </CardBody>
                                ...
                                <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap={6}>
                                    {material.gallery.map((imageUrl, index) => (
                                        ...
                                        >
                                            <Image
                                                src={imageUrl}
                                                alt={`${material.name} installation example ${index + 1}`}
                                                w="full"
                                                h="250px"
                                                objectFit="cover"
                                                loading="lazy"
                ...
                >
                    <Stack spacing={4} align="center">
                        ...
                        <Text maxW="2xl" color="gray.600" _dark={{ color: "gray.300" }}>
                            Get a personalized quote for your {material.name} ceiling installation. 
                            Our experts will help you design the perfect solution for your space.
                        </Text>
                        <HStack spacing={4}>
                            <Button size="lg" colorScheme="brand">
                                Get Free Quote
