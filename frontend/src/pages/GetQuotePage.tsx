...
import { ArrowLeft, Phone, Mail, MapPin, Clock, Calculator, Send } from "lucide-react";
        ...
        <main role="main" aria-label="Get quote and contact page">
                    ...
                    {contactInfo.map((info) => (
                        ...
                        >
                            <CardBody textAlign="center">
                                ...
                                <Heading size="sm" mb={2}>{info.title}</Heading>
                                <Text fontWeight="600" mb={1}>{info.value}</Text>
                                <Text fontSize="sm" color="slate.500">{info.description}</Text>
                            </CardBody>
                        </Card>
                    ))}
                </SimpleGrid>
                    ...
                    <Box>
                        <Stack spacing={6}>
                            <Stack spacing={3}>
                                ...
                                <Text color="slate.500">
                                    Get premium stretch ceilings with professional service and guaranteed quality.
                                </Text>
                            </Stack>

                            <Stack spacing={4}>
                                <Box p={5} bg="gray.50" _dark={{ bg: "gray.800" }} rounded="xl">
                                    <Heading size="sm" mb={2} color="brand.500">✓ Free Consultation</Heading>
                                ...
                                <Box p={5} bg="gray.50" _dark={{ bg: "gray.800" }} rounded="xl">
                                    <Heading size="sm" mb={2} color="brand.500">✓ Fast Installation</Heading>
                                    <Text fontSize="sm" color="slate.500">
                                ...
                                <Box p={5} bg="gray.50" _dark={{ bg: "gray.800" }} rounded="xl">
                                    <Heading size="sm" mb={2} color="brand.500">✓ 15-Year Warranty</Heading>
                                    <Text fontSize="sm" color="slate.500">
                                ...
                                <Box p={5} bg="gray.50" _dark={{ bg: "gray.800" }} rounded="xl">
                                    <Heading size="sm" mb={2} color="brand.500">✓ Expert Team</Heading>
                                    <Text fontSize="sm" color="slate.500">
            ...
            <Container py={{ base: 10, md: 16 }}>
                <Stack 
                    ...
                    rounded="2xl"
                >
                    <Heading size={{ base: "lg", md: "xl" }}>Need Immediate Assistance?</Heading>
                    ...
                    <HStack justify="center" spacing={4} pt={2}>
                        <Button size="lg" leftIcon={<Phone />}>Call Now: +1 (555) 123-4567</Button>
                        <Button size="lg" variant="outline" leftIcon={<Calculator />}>Price Calculator</Button>
                    </HStack>
                </Stack>
            </Container>
        </main>
