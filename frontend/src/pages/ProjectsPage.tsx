import { Container, Heading, Stack, Text, Button, HStack, SimpleGrid, Box, Image } from "@chakra-ui/react";
...
const projects = [
    {
        ...
        description: "Premium white stretch ceiling with integrated LED cove lighting"
    },
    {
        id: 2,
        ...
        description: "Glossy stretch ceiling with moisture-resistant finish and spot lights"
    },
    {
        id: 3,
    ...
    },
    {
        ...
        description: "Commercial stretch ceiling with track lighting for product display"
    }
];
        ...
        <Box>
            ...
            <Container py={{ base: 10, md: 16 }}>
                <Stack 
                    ...
                    rounded="2xl"
                >
                    <Heading size={{ base: "lg", md: "xl" }}>Ready to Start Your Project?</Heading>
                    <Text color="slate.500" fontSize={{ base: "md", md: "lg" }}>
                        Let us transform your space with premium stretch ceilings. Get a free consultation today.
                    </Text>
                    <HStack justify="center" spacing={4} pt={2}>
                        <Button size="lg" leftIcon={<Calculator />}>Get Free Estimate</Button>
                        <Button size="lg" variant="outline" leftIcon={<ExternalLink />}>View Gallery</Button>
                    </HStack>
                </Stack>
            </Container>
        </Box>
